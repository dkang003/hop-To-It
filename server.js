...
app.get('/test', (req, res) => {
    ...
    axios('xhttps://api.foursquare.com/v2/client_id/foursquare?client_id=process.env.clientId&client_secret=process.env.clientSecret&v=20180323&limit=100&ll=34.0522,-118.2437&query=brewery')
        .then(response => { 
